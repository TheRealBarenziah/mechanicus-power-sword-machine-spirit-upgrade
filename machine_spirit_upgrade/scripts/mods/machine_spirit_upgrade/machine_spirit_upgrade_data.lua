			...
			},
			{
				...
				sub_widgets = {
					checkbox("bar_enabled", false, {
						...
						{
							setting_id = "bar_cell_uses",
							type = "dropdown",
							default_value = 0,
							options = {
								{ text = "bar_cell_uses_auto", value = 0 },
								{ text = "bar_cell_uses_1", value = 1 },
								{ text = "bar_cell_uses_2", value = 2 },
								{ text = "bar_cell_uses_3", value = 3 },
								{ text = "bar_cell_uses_4", value = 4 },
								{ text = "bar_cell_uses_5", value = 5 },
							},
						},
